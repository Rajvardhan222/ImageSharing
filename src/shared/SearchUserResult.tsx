...
function SearchUserResult({profile}) {
    console.log(profile);
    
    return profile?.map((users, indexedDB) => {
        return (
          <div className=" flex flex-col justify-center items-center gap-y-4 px-10 py-12   w-64 " key={indexedDB}>
            <img
